...
NIGHT_OVERLAY: GameObject = None
MENU_BG = GameObject(pygame.image.load("images\\bg.png"), Point(0, 0))
STONE_WALL = GameObject(pygame.image.load("images\\stoneWall.png"), Point(0, 0))
GIANT_ZOMBIE_LEFT = GameObject(pygame.image.load("images\\giantzombie\\left.png"), Point(0, 0))
GIANT_ZOMBIE_RIGHT = GameObject(pygame.image.load("images\\giantzombie\\right.png"), Point(0, 0))